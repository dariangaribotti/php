...
if(isset($_SESSION["listadoClientes"])){
    // Si existe la variable de session listadoClientes asigno su contenido a clientes
            ...
            <div class="col-6">
                <form action="" method="POST">
                    ...
                    <div class="pb-3">
                        ...
                        <input type="text" name="txtDni" id="txtDni" class="form-control" placeholder="Ingrese su dni">
                    </div>
                    <div class="pb-3">
                        <label for="">Telefono:</label>
                        <input type="text" name="txtTelefono" id="txtTelefono" class="form-control" placeholder="+54 9 11 1234-5678">
                    </div>
                    <div class="pb-3">
                        <label for="txtEdad">Edad:</label>
                        <input type="number" name="txtEdad" id="txtEdad" class="form-control" placeholder="Ingrese su edad">
                    </div>
                    <div>
